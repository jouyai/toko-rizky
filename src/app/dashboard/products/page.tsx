...
export default function ProductsPage() {
  // Penting:
  // 1) schema pakai z.coerce.number()
  // 2) defaultValues angka = number
  // 3) register number pakai valueAsNumber
  // 4) cast resolver kalau TS masih ngeyel
  ...
  return (
    <main className="mx-auto max-w-2xl p-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        {/* Price */}
        <div className="space-y-1">
          <label htmlFor="price" className="block text-sm font-medium">Harga</label>
          <input
            id="price"
            type="number"
            className="w-full rounded border px-3 py-2"
        ...
        {/* Stock */}
        <div className="space-y-1">
          <label htmlFor="stock" className="block text-sm font-medium">Stok</label>
          <input
            id="stock"
            type="number"
            className="w-full rounded border px-3 py-2"
        ...
        {/* Image URL */}
        <div className="space-y-1">
          <label htmlFor="image" className="block text-sm font-medium">URL Gambar</label>
          <input
            id="image"
            type="url"
            className="w-full rounded border px-3 py-2"
